...
public class InvalidFlagException extends Exception {
    ...
    private static final long serialVersionUID = 3601533135741837987L;
    
    public InvalidFlagException(String message) {
        super(message);
    }
    
    public InvalidFlagException(String message, Throwable t) {
        super(message, t);
    }
    
    public InvalidFlagException(Throwable t) {
        super(t);
    }
